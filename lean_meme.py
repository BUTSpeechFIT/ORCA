...
def main():
    ...
    if args.load_checkpoint:
        ...
        scoring_model = meme_model.Meme.load_from_directory(args.load_checkpoint, lm, device=device)
    if args.resume:
        ...
        if args.lora_rank is not None:
            ...
            accelerator.print("Loaded LM model from checkpoint")
        scoring_model = meme_model.Meme.load_from_directory(latest_checkpoint, lm, device=device)
