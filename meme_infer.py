...
def main():
    parser = argparse.ArgumentParser(
        description="ORCA Inference Script", formatter_class=argparse.ArgumentDefaultsHelpFormatter
    )
    ...
    if args.test_set_is_labeled:
        inference_data = data_meme.UnifiedAnnotationDataset(
            args.data,
        ...
        inference_data = data_meme.InferenceDataset(
            args.data,
            skip_question=args.skip_question,
            skip_rationale=args.skip_rationale,
            add_transcript=args.add_transcript,
    ...
    if os.path.isfile(os.path.join(args.meme_model_path, "lm", "adapter_config.json")):
        base_model_name = json.load(
            open(os.path.join(args.meme_model_path, "lm", "adapter_config.json"))
